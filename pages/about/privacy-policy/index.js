      ...
      >
        <Text>
          <Title order={1} align="center">
            Privacy Policy for {process.env.NEXT_PUBLIC_SITE_NAME}
          </Title>

          <Text>
            At {process.env.NEXT_PUBLIC_SITE_NAME}, accessible from{" "}
            {process.env.NEXT_PUBLIC_SITE_URL}, one of our main priorities is
            the privacy of our visitors. This Privacy Policy document contains
            types of information that is collected and recorded by{" "}
            {process.env.NEXT_PUBLIC_SITE_NAME} and how we use it.
          </Text>
          ...
          <Text>
            ...
            {process.env.NEXT_PUBLIC_SITE_NAME}. This policy is not applicable
          ...
          <Text>
            {process.env.NEXT_PUBLIC_SITE_NAME} follows a standard procedure of
          ...
          <Text>
            Like any other website, {process.env.NEXT_PUBLIC_SITE_NAME} uses
          ...
          <Text>
            ...
            advertising partners of {process.env.NEXT_PUBLIC_SITE_NAME}.
          </Text>
          ...
          <Text>
            ...
            {process.env.NEXT_PUBLIC_SITE_NAME}, which are sent directly to
          ...
          <Text>
            Note that {process.env.NEXT_PUBLIC_SITE_NAME} has no access to or
          ...
          <Text>
            {process.env.NEXT_PUBLIC_SITE_NAME}'s Privacy Policy does not apply
          ...
          <Text>
            {process.env.NEXT_PUBLIC_SITE_NAME} does not knowingly collect any
